...
# Your code here
        if node not in self.n2c:
            self.n2c[node] = [(current, sign),]
        else:
            self.n2c[node].append((current, sign),)
################
...
################
# Your code here
        kclEquations = [le.Equation([1.0], [gnd], 0.0),]
...
################
# Your code here
        return le.Equation([1.0, -1.0, -1.0/self.K], [self.nPlus, self.nMinus, self.nOut], 0.0)
################
